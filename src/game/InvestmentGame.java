...
public class InvestmentGame {
	...
	// 뉴스
	private String[][] news = { { "1", "1", "국제 사회, 탄소 배출 규제 강화로 재생 에너지 수요 급증", "+" },
			...
			{ "7", "2", "물류 대란 지속, 전자상거래 플랫폼 배송 지연으로 소비자 불만 고조", "-" }, { "9", "2", "소비자 경기 침체로 전자상거래 매출 감소 우려", "-" },
			{ "10", "3", "새로운 건강 이슈 확산, 백신 및 의약품 수요 증가", "+" }, { "11", "3", "의료 혁신에 대한 투자 증가, 생명과학 기술 성장 기대", "+" },
			{ "12", "3", "약가 인상 논란 및 규제 강화, 바이오 기업 수익성 저하", "-" }, { "13", "3", "임상 시험 결과 부진으로 주요 신약 출시 연기", "-" },
			{ "14", "4", "AI 기술 수요 급증, 반도체 산업 투자 증가 예상", "+" }, { "15", "4", "글로벌 데이터 센터 확장으로 반도체 수요 폭증", "+" },
			{ "16", "4", "반도체 공급망 차질, 주요 부품 부족으로 업계 타격", "-" }, { "17", "4", "미중 무역 긴장 심화, 반도체 산업 규제 강화 우려", "-" },
			{ "18", "5", "메타버스 채택 증가, 다양한 기업들이 가상 현실에 투자 확대", "+" },
			{ "19", "5", "가상 회의 및 원격 근무 확산으로 메타버스 수요 증가", "+" },
			{ "10", "5", "기술 혁신 속도 둔화와 규제 강화, 메타버스 성장 기대 감소", "-" }, { "20", "5", "개인 정보 보호 이슈로 메타버스 플랫폼 신뢰도 하락", "-" },
			{ "21", "6", "정부 보조금 확대와 환경 규제 강화로 전기차 시장 성장 촉진", "+" },
			{ "22", "6", "전기차 충전 인프라 확장, 수요 증가로 업계 활성화 기대", "+" }, { "23", "6", "배터리 원자재 가격 급등, 전기차 제조 비용 상승 우려", "-" },
			{ "24", "6", "전기차 관련 리콜 증가, 안전성 논란으로 신뢰도 하락", "-" }, { "25", "7", "디지털 금융 혁신 가속화, 핀테크 시장 점유율 확대", "+" },
			{ "26", "7", "암호화폐 거래 서비스 도입, 디지털 자산 접근성 향상", "+" }, { "27", "7", "금융 규제 강화로 핀테크 기업들 수익성 하락 가능성", "-" },
			{ "28", "7", "디지털 보안 위협 증가, 고객 신뢰 하락 우려", "-" }, { "29", "8", "우주 탐사 기술 발전으로 상업 우주 여행 시대 가시화", "+" },
			{ "30", "8", "위성 인터넷 프로젝트 성공, 글로벌 네트워크 확장", "+" }, { "31", "8", "국제 우주 규제 강화, 상업 우주 프로젝트 진입 장벽 증가", "-" },
			{ "32", "8", "로켓 발사 실패 및 재정 손실로 우주산업 불안감 고조", "-" }, { "33", "9", "AI 기술 상용화 가속화, 다양한 산업에 활용 확대", "+" },
			{ "34", "9", "AI 데이터 분석 서비스로 광고 매출 신기록 달성", "+" }, { "35", "9", "AI 윤리 및 개인정보 보호 문제로 규제 당국의 감시 강화", "-" },
			{ "36", "9", "자율 AI 오작동 사례 증가로 기술 신뢰도 하락", "-" }, { "37", "10", "사이버 공격 급증, 보안 솔루션 수요 증가로 성장세 기대", "+" },
			...
			while (true) {
				...
				do {
					...
					for (int i = 0; i < turn; i++) {
						if (preNews[i][0].equals(news[rn][0])) { // 중복되는 뉴스 인덱스 발견
							isDuplicate = true;
							break; // 중복이면 루프 종료
						}
					}
				...
				case "3":
					...
					turn++;
					if (turn >= 15) {
						System.out.println("15턴이 지나 게임이 종료됩니다.");
						ingame = false; // 게임 종료
					}
					break;
				// 게임종료
